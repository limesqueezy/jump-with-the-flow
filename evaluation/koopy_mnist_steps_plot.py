...
from .cfm_mnist import load_net as load_cfm_net
...
def main():
    ...
    ap.add_argument("--koop-checkpoint", required=True,
                    help="Glob for Koopman .ckpt files")
    ap.add_argument("--cfm-checkpoint",  required=True,
    ...
    ap.add_argument("--out-dir",     default="qualitative_pairs_mnist")
    args = ap.parse_args()
